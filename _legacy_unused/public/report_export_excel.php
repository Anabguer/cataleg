...
if (report_dispatch_export_excel($db, $reportRow, $programYear, $includeDraft, $includePersonalData, $trainingTypeFilter, $initialDateOnly, $ambAssistentsRpefc02, $dadesInscritsRpefc04)) {
    exit;
}

http_response_code(501);
header('Content-Type: text/plain; charset=UTF-8');
echo 'Exportació Excel no disponible per a aquest informe.';
